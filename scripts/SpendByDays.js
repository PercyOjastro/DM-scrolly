	...
	*/
	...
	function scat2ter(scat2rows) {
		...
		xScat2.domain([0, d3.max(scat2rows, xVal2)]);
	    yScat2.domain([0, d3.max(scat2rows, yVal2)]);
	    	
	    // X Axis
	    var xAxisCall2 = d3.axisBottom(xScat2)
			.tickFormat(function(d){ return d; });		    	
	    xAxscat2.transition(d3.transition().duration(1000)).call(xAxisCall2);

	    // Y Axis
	    var yAxisCall2 = d3.axisLeft(yScat2)
	    	.tickFormat(function(d){ return d; });
	    yAxscat2.transition(d3.transition().duration(1000)).call(yAxisCall2);
